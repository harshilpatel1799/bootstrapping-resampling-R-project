###################
# FINAL PROJECT: PART 1C - STAT 3201(DONGES)
...
samples<-vector()
# use a loop to generate and record 1000 random sample means with x[i]~Gamma(5,1) from samples of size 25.
for (i in 1:numberOfSamples) {
  samples<- rgamma(sampleSize,alpha,scale = beta)
